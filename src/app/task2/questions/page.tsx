...
export default function Task2QuestionsPage() {
  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      // Submit timing data
      await updateTaskTime(taskId, participantId, 2, timeSeconds);
      
      // Submit questions
      await updateTaskQuestions(taskId, participantId, 2, question1, question2);
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col bg-white px-4 py-6 text-sm text-zinc-900">
      <header className="mb-6 text-center">
        ...
        <p className="mt-1 text-xs text-zinc-500">Task 2: Voice Chatbot - Questions</p>
      </header>
