...
import { getTask1DurationMs, getParticipantId } from "../../_lib/experimentStorage";
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col bg-white px-4 py-6 text-sm text-zinc-900">
      <header className="mb-6 text-center">
        ...
        <p className="mt-1 text-xs text-zinc-500">Task 1: Typing Chatbot - Complete</p>
      </header>
      ...
      <section className="flex-1 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-zinc-600">
            You have successfully completed the typing chatbot task.
          </p>
        </div>
